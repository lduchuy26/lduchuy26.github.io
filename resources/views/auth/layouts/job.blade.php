    ...
    <div class="container">     
        <div class="row">
            <div class="col-6 col-md-10 ">
                <h2 style="color: black; padding: 10px;">Tìm việc</h2>  
            </div>
        ...
        <div class="d-flex " >
            <div class=" col-lg-3 sidebar mb-4">
                <div class="card border-0 shadow p-4">
                    <div class="mb-4">
                        <h2 style="color: black;">Từ khóa</h2>
                        <input style="border-radius: 4px !important" type="text" id="txtTuKhoa" placeholder="Từ khóa, chức danh" class=" select1 selectpicker fz-18 letter-spacing-1" autocomplete="off"/>

                    </div>

                    <div class="mb-4">
                        <h2 style="color: black;">Địa điểm</h2>
                    ...
                    <div class="mb-4">
                        <h2 style="color: black;">Ngành nghề</h2>
                    ...
                    <div class="mb-4">
                        <h2 style="color: black;">Kiểu công việc</h2>
                    ...
                    <div class="mb-4">
                        <h2 style="color: black">Kinh nghiệm bản thân</h2>
                        <select name="category" id="category" class="form-control">
                            ...
                            <option value="">7 năm</option>
                            <option value="">8 năm</option>
                            <option value="">9 năm</option>
