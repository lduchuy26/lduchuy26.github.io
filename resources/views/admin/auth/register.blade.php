        ...
        <div class="row d-flex justify-content-center shadow-lg bg-white rounded">
            ...
            <div class="col-md-5"> 
                <div class="p-5 posistion-relative" >    
                    ...
                    <form class="form_login" action="{{ route('admin.register') }}" name="registrationForm" id="registrationForm">
                        ...
                        <div class="mt-4 text-center" style="margin-top: 1rem">
                            <p>Bạn đã có tài khoản? <a  href="{{ route('applicant.login') }}">Đăng nhập</a></p>
                        </div>
